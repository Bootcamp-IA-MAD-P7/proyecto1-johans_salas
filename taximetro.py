...
# ══════════════════════════════════════════════════════════════════════════════
# WIDGET: ítem de servicio — altura fija dp(56), sin scroll
# ══════════════════════════════════════════════════════════════════════════════
...
class TaximetroApp(MDApp):
    ...
    def on_start(self):
        # IMPORTANTE: service_list es ahora MDBoxLayout, no MDList
        # Se añaden ítems directamente sin ScrollView
    ...
    def mostrar_login(self):
        ...
        self._dialog_login = MDDialog(
            title="Iniciar Sesion", type="custom",
    ...
    def ver_historial(self):
        ...
        MDDialog(title="Historial de Trayectos", type="custom",
                 content_cls=scroll, size_hint=(0.9, 0.8)).open()
